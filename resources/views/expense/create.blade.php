...
<body class="bg-gray-100">
    <div class="container mx-auto mt-10 max-w-md">
        ...
        <form action="{{ route('expense.store') }}" method="POST" class="bg-white p-6 rounded shadow">
            @csrf

            <div class="mb-4">
                <label for="source" class="block text-sm font-medium text-gray-700">Expense Source</label>
